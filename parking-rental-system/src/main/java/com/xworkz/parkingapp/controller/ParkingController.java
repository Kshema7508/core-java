...
public class ParkingController {
	...
	@PostMapping("/login")
	public String userLogin(@RequestParam("emailId")String emailId,@RequestParam("password") String password,Model model,ParkingDTO dto,HttpServletRequest req) {
		System.out.println("Running login");
		
		ParkingDTO dtos=service.userSinghIn(emailId,password);
		if(dtos !=null) {
