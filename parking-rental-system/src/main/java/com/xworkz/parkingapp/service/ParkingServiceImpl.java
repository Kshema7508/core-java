...
public class ParkingServiceImpl implements ParkingService {
	...
	@Override
	public ParkingDTO adminSinghIn(String emailId, String password) {
		System.out.println("Running adminSinghIn");
		
		AdminEntity entity=this.repo.adminSingnInRepo(emailId);
		...
		if(entity.getEmailId().equals(emailId) && entity.getPassword().equals(password)){
			...
			AdminEntity updatedEntity=repo.adminSingnInRepo(emailId);
